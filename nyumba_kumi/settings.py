"""
Django settings for nyumba_kumi project.
...
SECRET_KEY = 'django-insecure-dmiy@+s@oyw148y)*j7u^a$!g&pw@1t_kiw4^9!m4^8+aibila'
...
WSGI_APPLICATION = 'nyumba_kumi.wsgi.application'
